...
- (void)viewDidLoad {
  ...
  textView_.text = @"이 텍스트는 편집할 수 있습니다.";
...
- (void)viewDidAppear:(BOOL)animated {
  ...
  [self textViewDidEndEditing:textView_]; //< 화면 표시 시에 비편집 모드로 한다 
}

- (void)viewWillDisappear:(BOOL)animated {
  [super viewWillDisappear:animated];
  [textView_ resignFirstResponder]; //< 화면 천이 시에 비편집 모드로 한다
}
...
- (void)textViewDidBeginEditing:(UITextView*)textView {
  ...
  // UITextView를 작게 해서 키보드에 감춰지지 않도록 한다
